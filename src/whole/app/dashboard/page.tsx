    ...
    <div className="container mx-auto p-6">
      ...
      <CreatePageModal
        ...
        onCreatePage={async (propertyData) => {
          try {
            console.log('Creating page with data:', propertyData);

            // Select a random design style
            const designStyle =
            ...
            // Generate AI content based on property data with the selected design style
            ...
            const aiContent = await generatePropertyContent(
              ...
              },
              {
                ...
                spacing: {
                  padding: designStyle.spacing === 'airy' ? '2rem' : '1rem',
                  sectionPadding: '4rem',
                  contentWidth: '1200px',
                },
                animations: {
                  type: designStyle.animations === 'subtle' ? 'fade' : 'slide',
                  duration: '0.3s',
                },
              }
            );
